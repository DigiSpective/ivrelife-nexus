-- ============================================================================
-- IV RELIFE Nexus - Complete Database Setup (FIXED VERSION)
-- ============================================================================
...
-- Version: 1.0.1 (Fixed generated column issues)
-- Created: 2025-09-23
-- ============================================================================
...
CREATE TABLE orders (
    ...
    order_number TEXT UNIQUE, -- Will be populated by trigger
...
CREATE TABLE inventory (
    ...
    quantity_available INTEGER DEFAULT 0, -- Updated by trigger
...
-- Create a default retailer for testing
...
BEGIN
    RAISE NOTICE '=================================================================';
    RAISE NOTICE 'IV RELIFE Nexus Database Setup Complete! (FIXED VERSION)';
    RAISE NOTICE '=================================================================';
    ...
    RAISE NOTICE 'Triggers: Created for order numbers, timestamps, and inventory';
