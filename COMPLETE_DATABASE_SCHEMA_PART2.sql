...
SELECT '✅ COMPLETE DATABASE SCHEMA INSTALLED' AS status;
...
SELECT
    ...
    COUNT(*) AS count
FROM pg_proc
WHERE proname IN ('update_updated_at_column', 'create_order_direct', 'get_user_retailer_ids', 'can_access_retailer', 'log_audit_event', 'generate_order_number');
...
SELECT '✅ Schema installation complete! Application ready to use.' AS final_status;